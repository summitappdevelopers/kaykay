...
var Kaycard = React.createClass({
	render: function() {
		var kaycardNodes = this.props.data.data.map(function(kaycard) {
			...
			return (
				<div style={cardStyle} className="task-card" key={kaycard._id}>
					<input className="input-box" type="text" placeholder="Title" />
					<textarea className="input-text" type="text" placeholder="Description"></textarea>
					<br />
